      ...
      <header className="relative h-96 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            ...
            >
                { isDarkMode ? (
                    <Image src="/images/company/logo-sab-white.svg" alt="SAB Logo" width={160} height={160} className="inline-block" />
                ) : (
                    <Image src="/images/company/logo-sab.svg" alt="SAB Logo" width={160} height={160} className="inline-block" />
                )}
            </motion.span>
          </motion.h1>
          <motion.p 
